...
public class SeparatorSample extends Application {
	...
	public void start(Stage stage) {
		...
		Image cloudImage = new Image(getClass().getResourceAsStream("fw1.png"));
		Image sunImage = new Image(getClass().getResourceAsStream("fw2.png"));

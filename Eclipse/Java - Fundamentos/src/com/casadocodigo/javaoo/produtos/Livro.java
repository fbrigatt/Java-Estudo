...
import com.casadocodigo.javaoo.exception.AutorNuloException;
...
public abstract class Livro implements Produto {
	...
	public void mostrarDetalhes() {
		...
		if (this.temAutor()) {
			...
			System.out.println("N�o existe Autor Cadastrado !!!");
		}
		System.out.println("-------------------------\n");
	}
	...
	// se o autor existir, return true, sen�o false
	boolean temAutor() {
	...
	// Note que o m�todo compareTo retorna um int. Devemos retornar
	// 0 (zero) se o objeto comparado (par�metro outro) for igual a este objeto
	// (this), um n�mero negativo se este objeto for menor (deva vir antes
	// quando ordenado) que o objeto passado, ou um n�mero positivo caso seja

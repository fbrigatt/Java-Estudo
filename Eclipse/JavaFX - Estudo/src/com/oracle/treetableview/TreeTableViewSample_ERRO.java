package com.oracle.treetableview;
...
public class TreeTableViewSample_ERRO extends Application {
	...
	private final ImageView depIcon = new ImageView(new Image(getClass().getResourceAsStream("ok.png")));

	final TreeItem<Employee> root = new TreeItem<>(new Employee("Sales Department", ""), depIcon);

	public static void main(String[] args) {
		Application.launch(TreeTableViewSample_ERRO.class, args);
	}

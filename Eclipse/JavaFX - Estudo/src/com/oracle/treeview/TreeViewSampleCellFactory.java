...
public class TreeViewSampleCellFactory extends Application {

	private final Node rootIcon = new ImageView(new Image(getClass().getResourceAsStream("not.png")));
	private final Image depIcon = new Image(getClass().getResourceAsStream("ok.png"));
	...
	public TreeViewSampleCellFactory() {

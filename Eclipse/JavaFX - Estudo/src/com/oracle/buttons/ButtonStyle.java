...
public class ButtonStyle extends Application {
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setScene(
				SceneBuilder.create().stylesheets(ButtonStyle.class.getResource("ButtonStyle.css").toExternalForm())
						.fill(Color.gray(0.9))
						.root(BorderPaneBuilder.create()
								.left(VBoxBuilder.create().spacing(10).padding(new Insets(20)).alignment(Pos.CENTER)
										.children(ButtonBuilder.create().text("Green").id("green").build(),
												...
												ToolBarBuilder.create().id("iphone-toolbar")
														.items(ButtonBuilder.create().text("iPhone").id("iphone")
																.build())
														.build(),
								...
								ButtonBuilder.create().text("Windows 7").id("windows7").build()).build())
						.center(VBoxBuilder.create().spacing(10).padding(new Insets(20)).alignment(Pos.CENTER)
								...
								.children(ButtonBuilder.create().text("Green").id("green").build(),
										...
										ButtonBuilder.create().text("Big Yellow").id("big-yellow").build(),
										ToolBarBuilder.create().id("iphone-toolbar")
												.items(ButtonBuilder.create().text("iPhone").id("iphone").build())
												.build(),
										ButtonBuilder.create().text("Large iPad Dark Grey").id("ipad-dark-grey")
												.build(),
										ButtonBuilder.create().text("Large iPad Grey").id("ipad-grey").build(),
										ButtonBuilder.create().text("OSX Lion (Default)").id("lion-default").build(),
										ButtonBuilder.create().text("OSX Lion").id("lion").build(),
										ButtonBuilder.create().text("Windows 7 (Default)").id("windows7-default")
												.build(),

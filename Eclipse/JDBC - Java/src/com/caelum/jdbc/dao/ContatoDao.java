...
public class ContatoDao {
	...
	public void adiciona(Contato contato) {
		...
		try {
			...
			System.out.println("Contato: " + contato.getNome() + " salvo no banco de dados");
	...
	public List<Contato> getLista() {
		try {
			...
			// PreparedStatement stmt = this.con.prepareStatement("select * from
			// contatos where nome like '%R%'");
